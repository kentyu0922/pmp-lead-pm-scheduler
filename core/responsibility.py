...
_PHASE_RULES = [
    # 招采与比选 (设计招采/施工招采/供应商比选/Pre-Q/短名单/回标/清标/定标/签约)
    (("招标", "招采", "Pre-Q", "资格预审", "RFP", "BOQ", "短名单", "回标", "清标", "定标", "中标",
      "述标", "比选", "发标", "发售", "备标", "合同", "签约", "R1", "R2", "BAFO", "LOI", "ROA", "谈判"), "业主方招采组", "招采经理"),
    # 启动与规划
    (("Phase 1", "项目启动", "Kick Off", "Kickoff", "PEP", "执行计划", "物业装修申请",
      "CI导则", "机电图获取", "空间需求", "任务书", "调研", "概念", "规划", "前置", "启动"), "业主方 PMO", "项目经理"),
    # 报建与施工许可证
    (("施工许可", "许可证", "报监", "质安监", "建管", "申报"), "报建专员", "政府建管窗口"),
    # 设计深化与图审
    (("设计", "图审", "效果图", "平面", "SD", "施工图", "专项设计", "专篇", "CD", "3D", "Rendering",
      "功能分区", "布局规划", "材料选型", "图审合格证", "图纸送审", "安全协议",
      "翻图", "LDI", "复核", "盖章", "扩初", "专项编制", "深化", "出图", "规范"), "设计院", "设计负责人"),
    # 长周期采购
    (("Phase 5", "采购", "家具", "设备", "FFU", "HEPA", "供应商", "交货", "Lead Time",
      "选标"), "业主方采购组", "对应品类供应商"),
    # 实体施工（覆盖机电/装饰/实验室/屋面/冷却塔等专业表述）
    (("Phase 6", "Phase 4", "施工", "Stage", "隐蔽", "地坪", "彩钢板", "围护", "龙骨", "拆除",
    ...
    (("Phase 7", "ISO", "验证", "采样", "粒子", "沉降菌", "空气质量", "盲测",
      "复测", "报告"), "第三方验证机构", "验证工程师"),
    # 竣工验收
    (("Phase 8", "Phase 5", "竣工", "验收", "备案", "联合审批", "消防", "安监", "环保"), "业主/政府验收组", "验收负责人"),
    # 搬迁入驻
    (("Phase 9", "Phase 8", "搬迁", "搬家", "入驻", "Handover", "移交", "培训", "交付",
      "运营"), "搬迁组/行政", "搬迁负责人"),
]
